...
import { createProject, listProjectsForOrganization } from "../services/project.service";
...
export const createProjectController = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(400).json({ message: error instanceof Error ? error.message : "Project creation failed" });
  }
};
